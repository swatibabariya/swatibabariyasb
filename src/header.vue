            ...
            <ul class="nav navbar-nav">
               ...
               <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><router-link :to="{name:'jeans',query:{product:'jeans'}}">Jeans</router-link></li>
                            <li><router-link :to="{name:'top',query:{product:'top'}}" >Top</router-link></li>
                            <li ><router-link :to="{name:'kurti',query:{product:'kurti'}}" >Kurti</router-link></li>
                            <li><router-link :to="{name:'shirt',query:{product:'shirt'}}" >Shirt</router-link></li>
                            <li ><router-link :to="{name:'all',query:{product:'all'}}" >All</router-link></li>
                        </ul>
                    </li>
